...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="Z:\Mods\civ 6\inca\dds\BACKGROUND_RL_INCA_DIPLO.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3856548561</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="BACKGROUND_RL_INCA_DIPLO.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="BACKGROUND_RL_INCA_DIPLO"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
