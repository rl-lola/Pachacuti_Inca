...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="Z:\Mods\civ 6\inca\dds\LEADER_RL_PACHACUTI_CUSTOM_LOADING.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1660045125</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_RL_PACHACUTI_CUSTOM_LOADING.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_RL_PACHACUTI_CUSTOM_LOADING"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
