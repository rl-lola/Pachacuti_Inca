...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="Z:\Mods\civ 6\inca\dds\BACKGROUND_RL_INCA_LOADING.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>434315139</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="BACKGROUND_RL_INCA_LOADING.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="BACKGROUND_RL_INCA_LOADING"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
